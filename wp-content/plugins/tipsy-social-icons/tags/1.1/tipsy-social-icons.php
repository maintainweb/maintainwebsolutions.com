...
Version: 1.1
Author: Tom McFarlin
Author URI: http://tommcfarlin.com/tipsy-social-icons
License:
...
class Tipsy_Social_Icons extends WP_Widget {
	...
	function Tipsy_Social_Icons() {
		...
		$this->WP_Widget('tipsy-social-icons', __('Tipsy Social Icons', 'tipsy-social-icons'), $widget_ops);
	...
	function widget($args, $instance) {
		...
		$deviantart = empty($instance['deviantart']) ? '' : apply_filters('dribbble', $instance['deviantart']);
