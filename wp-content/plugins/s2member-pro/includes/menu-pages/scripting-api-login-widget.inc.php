						...
						if (!is_multisite () || !c_ws_plugin__s2member_utils_conds::is_multisite_farm () || is_main_site ())
							{
								...
								echo '<p>The Pro Login Widget can also be configured with an <em>optional</em> array of <a href="http://www.primothemes.com/forums/viewtopic.php?f=40&t=12453#src_doc_s2member_pro_login_widget%28%29" target="_blank" rel="external">configuration parameters</a>.</p>' . "\n";
								/**/
